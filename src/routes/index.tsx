  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main id="top">
        ...
        {/* About */}
        <section id="about" className="relative scroll-mt-32 py-16">
          <div className="section-shell">
        ...
        {/* Services */}
        <section id="services" className="relative scroll-mt-32 py-16">
          <div className="section-shell">
        ...
        {/* Process */}
        <section id="process" className="relative scroll-mt-32 py-16">
          <div className="section-shell">
            <h2 className="text-3xl font-semibold tracking-tight md:text-5xl">
              {t.processTitle}
            </h2>
        ...
        {/* FAQ */}
        <section id="faq" className="relative scroll-mt-32 py-16">
        ...
        {/* Contact */}
        <section id="contact" className="relative scroll-mt-32 py-16">
          <div className="section-shell">
            <h2 className="text-3xl font-semibold tracking-tight md:text-5xl">
              {t.contactTitle}
            </h2>
